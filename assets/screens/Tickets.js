      ...
      return (
        <View style={Styles.fondo}>
          <View style={Styles.cont1}>
            <Text style={Styles.txtBtn}>Ticket</Text>
              ...
              {this.state.datos.map((item, index) => {
                return (
                  <TouchableOpacity 
                    style={Styles.row} 
                    key={item.idTicket} 
                    onPress={(event) => { this.props.navigation.navigate("DetalleTicket", { id: item.idTicket }) }}>
                    <Fontisto name="ticket-alt" size={24} color="black" />
                    <Text style={Styles.txtDesc10}>{item.fechaCreada}  {item.horaCreada}   ${item.total}</Text>
                    <AntDesign
                      name="right"
                      size={24}
                      color="black"
