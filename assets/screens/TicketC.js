...
import Styles from "../styles/TicketC";
      ...
      return (
        <View style={Styles.fondo}>
          <View style={Styles.cont1}>
            <Text style={Styles.txtBtn}>Ticket Confirmacion</Text>
          ...
          <View style={Styles.contenedorP}>
            ...
            >
              ...
              {this.state.datos.length == 0 ? (
                <Text>NO TIENES TICKETS EN CONFIRMACION</Text>
              ) : (
                <View></View>
              )}
              ...
              {this.state.datos.map((item, index) => {
                return (
                  <TouchableOpacity
                    style={Styles.row}
                    key={item.idTicket}
                    onPress={(event) => { this.props.navigation.navigate("aDetalleTicket", { id: item.idTicket,index:1 }) }}>
